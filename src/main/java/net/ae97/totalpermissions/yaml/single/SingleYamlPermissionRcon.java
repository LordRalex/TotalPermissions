 ...
 * @author Lord_Ralex
 */
public class SingleYamlPermissionRcon extends SingleYamlPermissionBase implements PermissionRcon {

    public SingleYamlPermissionRcon(YamlConfiguration config) {
        super(config);
    }
